        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-white p-6 rounded-2xl shadow-lg border border-slate-100">
              <h3 className="font-bold text-lg mb-4 flex items-center gap-2"><Info className="text-blue-600" size={20} /> Agenda:</h3>
            ...
            <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-slate-100 p-8 md:p-10">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200 space-y-6">
                  <h4 className="text-xs font-black text-blue-600 uppercase flex items-center gap-2"><Hash size={16} /> Perfil Técnico Actual</h4>
                ...
                <div className="space-y-6">
                  <h4 className="text-xs font-black text-blue-600 uppercase flex items-center gap-2"><Briefcase size={16} /> Planeación</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-slate-700">¿Proyecto de renovación activo?</label>
                      <div className="flex gap-8">
                        {['Si', 'No'].map((opt) => (
                          <label key={opt} className="flex items-center gap-2 cursor-pointer group">
                            ...
                            <span className="text-sm font-semibold text-slate-600 group-hover:text-blue-600">{opt}</span>
                          </label>
                        ))}
                      </div>
                    </div>
                ...
                <div className="pt-6 border-t border-slate-100">
                  ...
                  {!user && !error && <p className="text-center text-[10px] text-slate-400 mt-4 animate-pulse">Estableciendo conexión segura...</p>}
                </div>
              </form>
            </div>
          </div>
